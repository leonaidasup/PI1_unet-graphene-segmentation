...
El proyecto aborda el desafío del desbalance de clases y la escasez de datos (few-shot) utilizando una arquitectura U-Net con un encoder EfficientNet-B5 preentrenado. Se empleó una función de pérdida híbrida y optimización bayesiana para alcanzar una alta precisión (mIoU superior a 0.80) en la distinción entre las clases críticas: \textit{few-layer}, \textit{bulk} y background.
